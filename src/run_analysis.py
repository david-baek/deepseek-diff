...
weight_path = "../checkpoints/version_2/qwen-14b_13.pt"
...
top_feat_list = torch.topk(normalized_relative_norms, 100)[1]
...
# %%
top_feat_list = torch.topk(1-normalized_relative_norms, 100)[1]
